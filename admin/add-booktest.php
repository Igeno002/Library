...
$booknewname=md5($bookfile.time()).$extension1;
...
$sql="INSERT INTO  booktest(BookName,CatId,AuthorId,ISBNNumber,BookPrice,bookImage,BookFile) VALUES(:bookname,:category,:author,:isbn,:price,:imgnewname,:booknewname)";
